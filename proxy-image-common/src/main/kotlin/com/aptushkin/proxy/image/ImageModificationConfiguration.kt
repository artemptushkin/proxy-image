...
class ImageModificationConfiguration {
    ...
    class CropImageGatewayFilterFactory(
            decoratedFactory: ModifyResponseBodyGatewayFilterFactory, resizeModifierFactory: ImageModifierFactory<CropImageConfig>)
        : ModifyImageGatewayFilterFactory<CropImageConfig>(decoratedFactory, resizeModifierFactory, CropImageConfig::class.java)
}
